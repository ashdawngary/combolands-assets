...
Create 3 Rocks on random tiles in range  
...
| Field | Value |
| --- | --- |
| Catalog ID | `corrupted-mine` |
| Game tag | `CorruptedMine` (400) |
| Categories | Hazard |
| Draft group | Default |
...
![Corrupted Mine — Card preview](card-preview.png)

### Information card

![Corrupted Mine — Information card](info-card.png)
...
<a href="context-grass.png"><img src="context-grass.png" alt="Corrupted Mine on grass" width="104"></a><br>
<sub>Grass</sub>
</td>
</tr>
</table>
...
- [Normalized building record](../../../data/entities/buildings/corrupted-mine.json)
