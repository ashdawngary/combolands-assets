...
Passively: buildings in range cannot gain Reroll Remove Dismiss or Gold  
...
| Field | Value |
| --- | --- |
| Catalog ID | `corrupted-grove` |
| Game tag | `CorruptedGrove` (406) |
| Categories | Hazard |
| Draft group | Default |
...
![Corrupted Grove — Card preview](card-preview.png)

### Information card

![Corrupted Grove — Information card](info-card.png)
...
<a href="context-grass.png"><img src="context-grass.png" alt="Corrupted Grove on grass" width="104"></a><br>
<sub>Grass</sub>
</td>
</tr>
</table>
...
- [Normalized building record](../../../data/entities/buildings/corrupted-grove.json)
